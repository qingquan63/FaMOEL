...
class Population:
    ...
    def save(self, dirName='Result', Gen=0, All_objs_train=None, All_objs_valid=None, All_objs_ensemble=None, All_objs_test=None, passtime=None):
        ...
        if self.sizes > 0:
            ...
            if All_objs_test is not None:
                save_filename = '/allobjs/passtime.txt'
                with open(dirName + save_filename, 'w') as file:
                    file.write(str(passtime))
                    file.close()

    def save_metrics(self, dirName='Result', Gen=0, All_objs_train=None, All_objs_valid=None, All_objs_ensemble=None, All_objs_test=None):
        ...
        if self.sizes > 0:
            ...
            if All_objs_train is not None:
                save_filename = '/allobjs/ALL_metric_train_gen%d_sofar.csv' % Gen
                record_gen = list(All_objs_train.keys())
                with open(dirName + save_filename, 'a+') as file:
                    for gen in record_gen:
                        popobj = All_objs_train[gen]
            ...
            if All_objs_valid is not None:
                save_filename = '/allobjs/ALL_metric_valid_gen%d_sofar.csv' % Gen
                record_gen = list(All_objs_valid.keys())
                with open(dirName + save_filename, 'a+') as file:
                    for gen in record_gen:
                        popobj = All_objs_valid[gen]
            ...
            if All_objs_ensemble is not None:
                save_filename = '/allobjs/ALL_metric_ensemble_gen%d_sofar.csv' % Gen
                record_gen = list(All_objs_ensemble.keys())
                with open(dirName + save_filename, 'a+') as file:
                    for gen in record_gen:
                        popobj = All_objs_ensemble[gen]
            ...
            if All_objs_test is not None:
                save_filename = '/allobjs/ALL_metric_test_gen%d_sofar.csv' % Gen
                record_gen = list(All_objs_test.keys())
                with open(dirName + save_filename, 'a+') as file:
                    for gen in record_gen:
                        popobj = All_objs_test[gen]
